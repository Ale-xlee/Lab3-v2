...
author: "Team Name: Julia, Maisie, Alex Lee and Raven Callaghan"
date: "`r Sys.Date()`"
...
```{r Ex1, message = FALSE}
ex1_part1 <- plastic_data_all %>% filter(mismanaged_plastic_ocean != 0) %>% count(region)
ex1_part1
...
#Asia has the most coastal countries
